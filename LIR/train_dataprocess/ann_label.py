...
for fn in os.listdir(ann_path):
    ...
    for i in range(page_count):
        ...
        line_item_extractions = data["line_item_extractions"]
        for line_item_extraction in line_item_extractions:
            page_idx = line_item_extraction["page"]
            if page_idx == i:
                point = line_item_extraction["bbox"]
                text = line_item_extraction["text"]
                fieldtype = line_item_extraction["fieldtype"]
                line_item_id = line_item_extraction["line_item_id"]
