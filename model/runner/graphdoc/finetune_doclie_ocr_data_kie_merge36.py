...
from libs.data.doclie_kie_merge import create_dataset, DataCollator

import layoutlmft
import transformers
from layoutlmft.data.data_args import DataTrainingArguments
from layoutlmft.models.model_args import ModelArguments
from layoutlmft.trainers import DocLIETrainer as Trainer
...
def main():
    ...
    config = AutoConfig.from_pretrained(
        ...
        num_labels=len(cfg.Docliekie_vocab),
    ...
    train_dataset = create_dataset(cfg.train_npy_paths, cfg.Docliekie_vocab, cfg)
    eval_dataset = create_dataset(cfg.valid_npy_paths, cfg.Docliekie_vocab, cfg)
    ...
    trainer = Trainer(
        ...
        compute_metrics=compute_metrics(cfg.Docliekie_vocab),
    )
