...
from layoutlmft.models.graphdoc.modeling_confusion import InferLirMerge
...
if __name__ == "__main__":
    ...
    model = InferLirMerge.from_pretrained(
    ...
    for image_name,image_infos in tqdm.tqdm(input_data.items()):
        ...
        model(image=image, bbox=bbox, attention_mask=attention_mask, \
            inputs_embeds=sentence_embeddings, image_infos=image_infos, output_path=args.output_dir)
