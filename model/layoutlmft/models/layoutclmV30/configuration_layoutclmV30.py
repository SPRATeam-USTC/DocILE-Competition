...
class LayoutCLMv30Config(LayoutLMv2Config):
    model_type = "layoutclmV30"
    ...
    def __init__(
        ...
        sentence_model='https://huggingface.co/sentence-transformers/roberta-base-nli-stsb-mean-tokens',
        mask_embed='/path/to/mask_embedding.npy',
        vision_freeze=False,
        ...
        vision_pretrain='/path/to/swin_t.pth',
        vision_size=256,
        **kwargs
    ):
        super().__init__(
